...
<body>
	...
	* jQuery방식으로 AJAX통신
	...
	$.ajax({
	    url : "요청할 url" (action url), < 반드시 써야함
	    type : "전송 방식" (get, post방식), < 없으면 안써도 댐
	    data : "요청시 전달할 값", < 없으면 안써도 댐
...
-->
	...
	나이 : <input type="number" id="age"> <111111111111111111111111111111111111111111111111ㄹ됻ㅀㅇㄴㅍㅎㅈㄴㅊㅌ	</script>
